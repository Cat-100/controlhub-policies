...
9. [Do Other Regions Have Specific Privacy Rights?](#9-do-other-regions-have-specific-privacy-rights)
...
We collect certain information automatically when you visit or use our Services.

- **Log and Usage Data:** Includes IP address, browser type, device data, etc.
- **Location Data:** May include geolocation data based on IP address or GPS.
...
We share data with service providers and in specific business circumstances.
...
Submit a data subject access request or contact us to make changes to your personal data.
